  ...
  <div id="company-page" class="row center center-align">
    ...
    <div class="center col s12 m10 offset-m1 l10 offset-l1 ">
      ...
      <!-- Add modal -->
      <?php 
        require_once dirname(__FILE__) . "/centro_modal.php";
      ?>
    </div> 
  </div>
  ...
  <script type="text/javascript" src="js/plugins/jsgrid/js/jsgrid-script-centro.js"></script>
