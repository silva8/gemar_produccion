  ...
  <div id="company-page" class="row center center-align">
    <h4>Agregar / Editar Contactos</h4>
    <div class="center col s12 m10 offset-m1 l10 offset-l1 ">
      ...
      <!-- Add modal -->
      <?php 
        require_once dirname(__FILE__) . "/contacto_modal.php";
      ?>
    </div> 
  </div>
  ...
  <script type="text/javascript" src="js/plugins/jsgrid/js/jsgrid-script-contactos.js"></script>
